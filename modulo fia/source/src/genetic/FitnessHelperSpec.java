...
public class FitnessHelperSpec implements FitnessHelper {
    ...
    public FitnessHelperSpec(double performance, double camera, double display, Date now, int minBattery, int maxBattery){
    ...
    public double computeSpecFit(Spec spec) {
        ...
        double batteryF = spec.getBattery()/(maxBattery/10.0);
